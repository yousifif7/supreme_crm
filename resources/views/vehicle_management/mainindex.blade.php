    ...
    <div class="row">
        <div class="col-12">
            ...
            <ul class="nav nav-tabs" id="vehicleTabs" role="tablist" style="padding-top: 70px; margin-left: 250px;">
                ...
                <li class="nav-item">
                    <a class="nav-link" id="roadworthiness-tab" data-bs-toggle="tab" href="#roadworthiness" role="tab">
...
$(document).ready(function() {
    function loadTab(tabId, url) {
        if ($(tabId).is(':empty')) {
            $.get(url, function(data) {
                ...
                // Ensure DataTable renders properly
    ...
    // Fix DataTable responsiveness when switching tabs
    $('#vehicleTabs a[data-bs-toggle="tab"]').on('shown.bs.tab', function () {
        $($.fn.dataTable.tables(true)).DataTable().columns.adjust();
    });
});
