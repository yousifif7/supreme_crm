...
<div class="page-wrapper">
    <div class="content">
        ...
        <div class="d-flex my-xl-auto justify-content-between align-items-center flex-wrap ">
            <div class="me-2">
                <div class="dropdown">
                    <button class="btn btn-primary" id="bulkAlertsDeleteBtn">Delete Selected</button>
        ...
        <div class="card">
            ...
            <div class="card-body p-0">
                <div class="custom-datatable-filter table-responsive">
                    <table id="alert-reminders-table"
                        ...
                        <thead>
                            <tr>
                                ...
                                <th>Tachograph Calibration Date</th>
                                <th>Action</th>
                            </tr>
                        </thead>
                    </table>
        ...
        <!-- Delete Modal -->
        <div class="modal fade" id="alert_delete_modal">
                ...
                <div class="modal-content">
                    <div class="modal-body text-center">
                        ...
                        <div class="d-flex justify-content-center">
                            ...
                            <button type="button" id="confirmAlertDeleteBtn" class="btn btn-danger">Yes,
                                Delete</button>
                        </div>
                    </div>
                </div>
    ...
    <script>
        ...
        function deleteReminder(record_id) {
            ...
            $('#alert_delete_modal').modal('show');
        }

        document.getElementById('confirmAlertDeleteBtn').addEventListener('click', function() {
            if (selectedId !== null) {
                $.ajax({
                    ...
                    success: function(response) {
                        closeBsModal('#alert_delete_modal');
        ...
        // Bulk delete button
        $('#bulkAlertsDeleteBtn').on('click', function() {
    ...
    <script>
        $(document).ready(function() {
            let table = $('#alert-reminders-table').DataTable({
                processing: true,
                serverSide: true,
                ...
                columns: [{
                    ...
                    {
                        data: 'tax_renewal_date'
                    },
                    {
                        data: 'service_due_date'
                    },
                    {
                        data: 'tachograph_calibration_date'
                    },
                    {
                        data: 'action',
                        orderable: false,
            ...
            // ✅ Reload helper after CRUD actions
            window.reloadAlertRemindersTable = function() {
