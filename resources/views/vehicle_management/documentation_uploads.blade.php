...
<div class="page-wrapper">
    <div class="content">
        ...
        <div class="d-flex my-xl-auto justify-content-between align-items-center flex-wrap ">
            <div class="me-2">
                <div class="dropdown">
                    <button class="btn btn-primary" id="docsbulkDeleteBtn">Delete Selected</button>
        ...
        <div class="card">
            ...
            <div class="card-body p-0">
                <div class="custom-datatable-filter table-responsive">
                    <table id="documentation-uploads-table"
        ...
        <!-- Delete Modal -->
        <div class="modal fade" id="docs_delete_modal">
                ...
                <div class="modal-content">
                    <div class="modal-body text-center">
                        ...
                        <div class="d-flex justify-content-center">
                            ...
                            <button type="button" id="confirmDocsDeleteBtn" class="btn btn-danger">Yes,
                                Delete</button>
                        </div>
                    </div>
                </div>
    ...
    <script>
        ...
        function deleteDocumentation(record_id) {
            ...
            $('#docs_delete_modal').modal('show');
        }

        document.getElementById('confirmDocsDeleteBtn').addEventListener('click', function() {
            if (selectedId !== null) {
                $.ajax({
                    ...
                    success: function(response) {
                        closeBsModal('#docs_delete_modal');
        ...
        // Bulk delete button
        $('#docsbulkDeleteBtn').on('click', function() {
    ...
    <script>
        $(document).ready(function() {
            let table = $('#documentation-uploads-table').DataTable({
                processing: true,
                serverSide: true,
                ...
                columns: [{
                    ...
                    {
                        data: 'tax_confirmation',
                        orderable: false,
                        searchable: false
                    },
                    {
                        data: 'tachograph_certificate',
                        orderable: false,
                        searchable: false
                    },
                    {
            ...
            window.reloadDocumentationTable = function() {
