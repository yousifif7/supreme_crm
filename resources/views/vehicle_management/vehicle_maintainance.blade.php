...
<div class="page-wrapper">
    <div class="content">
        ...
        <div class="d-flex my-xl-auto justify-content-between align-items-center flex-wrap ">
            <div class="me-2">
                <div class="dropdown">
                    <button class="btn btn-primary" id="maintbulkDeleteBtn">Delete Selected</button>
        ...
        <div class="card">
            ...
            <div class="card-body p-0">
                <div class="custom-datatable-filter table-responsive">
                    <table id="vehicle-maintenances-table"
        ...
        <!-- Delete Modal -->
        <div class="modal fade" id="maintain_delete_modal">
                ...
                <div class="modal-content">
                    <div class="modal-body text-center">
                        ...
                        <div class="d-flex justify-content-center">
                            ...
                            <button type="button" id="confirmMainDeleteBtn" class="btn btn-danger">Yes,
                                Delete</button>
                        </div>
                    </div>
                </div>
    ...
    <script>
        ...
        function deleteMaintenance(record_id) {
            ...
            $('#maintain_delete_modal').modal('show');
        }

        document.getElementById('confirmMainDeleteBtn').addEventListener('click', function() {
            if (selectedId !== null) {
                $.ajax({
                    ...
                    success: function(response) {
                        closeBsModal('#maintain_delete_modal');
        ...
        // Bulk delete button
        $('#maintbulkDeleteBtn').on('click', function() {
