...
<div class="page-wrapper">
    <div class="content">
        ...
        <div class="d-flex my-xl-auto justify-content-between align-items-center flex-wrap ">
            <div class="me-2">
                <div class="dropdown">
                    <button class="btn btn-primary" id="CompbulkDeleteBtn">Delete Selected</button>
        ...
        <div class="card">
            ...
            <div class="card-body p-0">
                <div class="custom-datatable-filter table-responsive">
                    <table id="vehicle-compliances-table"
                        class="table table-row-bordered table-row-dashed gy-4 align-middle fw-bold">
                        <thead>
                            <tr>
                                <th><input type="checkbox" id="compselectAll"></th>
                                <th>#</th>
                                <th>Vehicle RN</th>
    ...
    <!-- Delete Modal -->
    <div class="modal fade" id="comp_delete_modal">
            ...
            <div class="modal-content">
                <div class="modal-body text-center">
                    ...
                    <div class="d-flex justify-content-center">
                        ...
                        <button type="button" id="compConfirmDeleteBtn" class="btn btn-danger">Yes, Delete</button>
                    </div>
                </div>
            </div>
        </div>
...
<script>
    ...
    function deleteCompliance(record_id) {
        ...
        $('#comp_delete_modal').modal('show');
    }

    document.getElementById('compConfirmDeleteBtn').addEventListener('click', function() {
        if (selectedId !== null) {
            $.ajax({
                ...
                success: function(response) {
                    closeBsModal('#comp_delete_modal');
    ...
    // Bulk delete button
    $('#CompbulkDeleteBtn').on('click', function() {
    ...
    $('#vehicle-compliances-table').DataTable({
        processing: true,
        serverSide: true,
        ajax: '{{ route('complainces.data') }}',
        columns: [{
                data: 'checkbox',
                orderable: false,
                searchable: false
            ...
            {
                data: 'vehicle_tax_status'
            },
            {
                data: 'tax_expiry_date'
            },
            {
                data: 'lez_ulez_compliant'
            },
            {
                data: 'action',
                orderable: false,
    ...
    $('#compselectAll').on('click', function() {
