                ...
                <div class="card">
                    <form action="{{ route('admin.setting.create') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            ...
                            placeholder="{{'login_logo '}}"
                            value="{{old('login_logo')}}">
                            @php
                        ...
                        @if (file_exists($filePath) && $headerLogo)
                            ...
                            <div class="thumb-container">
                                <img src="{{ asset('backend/websitedata/' . get_setting('login_logo')) }}" class="img-thumbnail mt-2" width="100px" height="100px">
                            </div>
                            @else
                        @endif
                            ...
                            placeholder="{{'dashboard_logo '}}"
                            value="{{old('dashboard_logo')}}">
                            @php
                        ...
                        @if (file_exists($filePathdasg) && $dashLogo)
                            ...
                            <div class="thumb-container">
                                <img src="{{ asset('backend/websitedata/' . get_setting('dashboard_logo')) }}" class="img-thumbnail mt-2" width="100px" height="100px">
                            </div>
                            @else
                        @endif
                        ...
                        @if (file_exists($filePathava) && $avatarLogo)
                            ...
                            <div class="thumb-container">
                                <img src="{{ asset('backend/websitedata/' . get_setting('avatar')) }}" class="img-thumbnail mt-2" width="100px" height="100px">
                            </div>
                            @else
                        @endif
                            ...
                            placeholder="{{'favicon_logo '}}"
                            value="{{old('favicon_logo')}}">
                        ...
                        @if (file_exists($filePathfav) && $favLogo)
                            ...
                            <div class="thumb-container">
                                <img src="{{ asset('backend/websitedata/' . get_setting('favicon_logo')) }}" class="img-thumbnail mt-2" width="100px" height="100px">
                            </div>
                            @else
                        @endif
