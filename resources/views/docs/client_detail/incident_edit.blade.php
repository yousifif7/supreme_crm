                        ...
                        @if (!empty($edit->$field))
                            <div class="col-md-6 mb-3">
                                ...
                                @elseif(str_contains($field, 'date'))
                                    <input type="date" name="{{ $field }}" value="{{ $edit->$field }}"
                                        class="form-control" readonly>
                                @elseif(str_contains($field, 'time'))
                                    <input type="time" name="{{ $field }}" value="{{ $edit->$field }}"
                                        class="form-control" readonly>
                                @elseif(str_contains($field, 'actions') ||
                                        str_contains($field, 'details') ||
                                        str_contains($field, 'outcome') ||
                                        str_contains($field, 'witnesses'))
                                    <textarea name="{{ $field }}" class="form-control" rows="3" readonly>{{ $edit->$field }}</textarea>
                                @else
                                    <input type="text" name="{{ $field }}" value="{{ $edit->$field }}"
                                        class="form-control" readonly>
                                @endif
                            </div>
                        @endif
