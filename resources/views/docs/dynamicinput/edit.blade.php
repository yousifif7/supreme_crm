...
@extends('layouts.app')
@section('contents')		
@section('title') Dynamic Form Update @endsection
                                            ...
                                            <div class="mb-3 row">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="mb-3 row">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <input type="text" class="form-control" id="placeholder" name="value" placeholder="{{ ('value') }}" value="{{$dynamicInput->value}}">
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="row">
                                                ...
                                                <div class="col-sm-10">
                                                    <select class="js-example-basic-single form-control" name="type" required>
                                                        ...
                                                        @foreach($types as $value => $label)
                                                            <option value="{{ $value }}" {{ ($dynamicInput->type === $value) ? 'selected' : '' }}>
                                                                {{ $label }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                        ...
                                        <div class="col-md-12">
                                            <div class="mb-3 row">
                                                ...
                                                <div class="col-sm-10 pt-6">
                                                    <input type="checkbox" class="form-check-input" id="min_limit_check" name="min_limit_check" value="1" {{ isset($dynamicInput) && $dynamicInput->min_limit_check ? 'checked' : '' }}>
                                        ...
                                        <div class="col-md-12">
                                            <div class="mb-3 row">
                                                ...
                                                <div class="col-sm-10 pt-6">
                                                    <input type="checkbox" class="form-check-input" id="max_limit_check" name="max_limit_check" value="1" {{ isset($dynamicInput) && $dynamicInput->max_limit_check ? 'checked' : '' }}>
                                                    <small class="form-text text-muted">Not Applied to 'Date', 'Bool', 'HTML' and 'File' Type fields</small>
                                                </div>
                                            </div>
                                        </div>
                                      ...
                                      {{--    <div class="col-md-12">
                                        ...
                                        <div class="col-md-12">
                                            <div class="mb-3 row">
                                                ...
                                                <div class="col-sm-10 pt-6">
                                                    <input type="checkbox" class="form-check-input" id="lebelstatus" name="label_status" value="1" {{ isset($dynamicInput) && $dynamicInput->label_status ? 'checked' : '' }}>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="mb-3 row">
                                                ...
                                                <div class="col-sm-10 pt-6">
                                                    <input type="checkbox" class="form-check-input" id="unique" name="unique" value="1" {{ isset($dynamicInput) && $dynamicInput->unique ? 'checked' : '' }}>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="mb-3 row">
                                                ...
                                                <div class="col-sm-10 pt-6">
                                                    <input type="checkbox" class="form-check-input" id="required" name="required" value="1" {{ isset($dynamicInput) && $dynamicInput->required ? 'checked' : '' }}>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="mb-3 row">
                                                ...
                                                <div class="col-sm-10 pt-6">
                                                    <select class="form-control" name="header_status">
                                                         <option value="other" @if($dynamicInput->header_status == 'other') selected @endif>Others</option>
                                                        <option value="0" @if($dynamicInput->header_status == '0') selected @endif>Table</option>
                                                        <option value="1" @if($dynamicInput->header_status == '1') selected @endif>Header</option>
                                                        <option value="2" @if($dynamicInput->header_status == '2') selected @endif>Footer</option>
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
