                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="row">
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" id="info" name="info"
                                                placeholder="{{ 'Info' }}">
                                            <small class="form-text text-muted">Info text will display under
                                                field</small>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-sm-10">
                                            <small class="form-text text-muted">Description will display above the
                                                field</small>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="mb-3 row">
                                        <label class="col-sm-2 col-form-label" for="min_limit_check">Has Min Character
                                            Limit</label>
                                        <div class="col-sm-10 pt-6">
                                            <input type="checkbox" class="form-check-input" id="min_limit_check"
                                                name="min_limit_check">
                                            <small class="form-text text-muted">Not Applied to 'Date', 'Bool', 'HTML'
                                                and 'File' Type fields</small>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <div class="mb-3 row">
                                        <label class="col-sm-2 col-form-label" for="min_limit_input">Min Character
                                            Limit</label>
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" id="min_limit_input"
                                                name="min_limit_input" placeholder="{{ 'Min Character Limit' }}">
                                ...
                                <div class="col-md-12">
                                    <div class="mb-3 row">
                                        <label class="col-sm-2 col-form-label" for="max_limit_check">Has Max Character
                                            Limit</label>
                                        <div class="col-sm-10 pt-6">
                                            <input type="checkbox" class="form-check-input" id="max_limit_check"
                                                name="max_limit_check">
                                            <small class="form-text text-muted">Not Applied to 'Date', 'Bool', 'HTML'
                                                and 'File' Type fields</small>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-12">
                                    <div class="mb-3 row">
                                        <label class="col-sm-2 col-form-label" for="max_limit_input">Max Character
                                            Limit</label>
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" id="max_limit_input"
                                                name="max_limit_input" placeholder="{{ 'Max Character Limit' }}">
