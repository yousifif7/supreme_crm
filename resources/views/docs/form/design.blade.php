    ...
    <label class="form-title @if($input->required == 1) required @endif" 
        ...
        <p>{!! $input->title !!}</p>
                ...
                @if(in_array($input->type, ['text', 'email', 'number', 'date', 'password', 'tel', 'url']))
                    <input type="{{$input->type}}" class="form-control" name="name[{{$input->id}}]" placeholder="{{ $input->placeholder }}">
                ...
                @elseif($input->type === 'radio')
                    @foreach($input->child as $option)
                        <div class="form-check form-check-inline">
                            <input class="form-check-input custom-radio-black" type="radio" name="name[{{$input->id}}]" value="{{ $option->title }}" id="flexCheckDefault{{$option->id}}">
                            <label class="form-check-label" for="flexCheckDefault{{$option->id}}">{{ $option->title }}</label>
                        </div>
                    @endforeach
                @elseif($input->type === 'checkbox')
                    @foreach($input->child as $child)
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="name[{{$input->id}}][]" value="{{ $child->title }}">
                ...
                @elseif($input->type === 'time')
                    <div class="container">
                        <div class="input-group">
                            <input type="text" id="datetimepicker{{$input->id}}" class="form-control datetimepicker" placeholder="Select Time" name="name[{{$input->id}}]">
                        </div>
                    </div>
                @endif
            </div>
