            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row">
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control slug-input" type="text" name="title"
                                        placeholder="Enter name" value="{{ old('title', $career->title) }}">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="mb-3 row">
                                <label class="col-sm-2 col-form-label" for="name">Add Mail Message<span
                                        class="text-danger">*</span></label>
                                <div class="col-sm-10">
                                    <textarea class="form-control basic-conf" placeholder="Description.." name="mail_desc" style="height: 150px"
                                        id="summernotemail">{{ old('desc', $career->mail_desc) }}</textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="mb-3 row">
                                <label class="col-sm-2 col-form-label" for="name">Success Message<span
                                        class="text-danger">*</span></label>
                                <div class="col-sm-10">
                                    <input class="form-control" type="text" name="success_message"
                                        placeholder="Enter Success Message"
                                        value="{{ old('success_message', $career->success_message) }}">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="mb-3 row">
                                <label class="col-sm-2 col-form-label" for="name">Failure Message<span
                                        class="text-danger">*</span></label>
                                <div class="col-sm-10">
                                    <input class="form-control" type="text" name="failure_message"
                                        placeholder="Enter Failure Message"
                                        value="{{ old('failure_message', $career->failure_message) }}">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control" type="text" name="receiver_mail"
                                        placeholder="Enter Receiver mail" value="{{ $career->receiver_mail }}">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="date" class="form-control" name="tax_date"
                                        value="{{ $career->tax_date }}">
                                </div>
                                <div class="col-md-4 mb-3">
                                    <label class="form-label">Invoice Number</label>
                                    <input type="text" class="form-control" name="invoice_number"
                                        value="{{ $career->invoice_number }}">
                                </div>
                                <div class="col-md-4 mb-3">
