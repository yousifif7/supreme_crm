                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="mb-3 row">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <input class="form-control name-input" type="text" name="title" placeholder="Enter name" value="{{ $edit->title }}">
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-12">
                                                    <div class="mb-3 row">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <input class="form-control slug-input" type="text" name="slug" placeholder="Slug" value="{{ $edit->slug }}">
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-12">
                                                    <div class="mb-3 row">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <textarea id="summernote" class="form-control basic-conf" placeholder="Description.." name="desc" style="height: 150px">{{ $edit->desc }}</textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-12">
                                                    <div class="mb-3 row">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <textarea id="summernote1" class="form-control basic-conf" placeholder="Description.." name="longdesc" style="height: 150px">{{ $edit->longdesc }}</textarea>
                                                        </div>
                                                    </div>
                                                </div>
