                            ...
                            <tbody>
                                @forelse ($checkCalls as $checkCall)
                                    ...
                                    <tr>
                                        <td>
                                            @if ($ccShiftDateId)
                                                <a href="{{ route('shiftDates.view', ['shiftDate' => $ccShiftDateId]) }}">{{ $ccLabel }}</a>
                                            @else
                                                {{ $ccLabel }}
                                            @endif
                                        </td>
                                    ...
                                    @foreach ($shifts as $shift)
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                @if ($siteName !== '-')
                                                    <a href="{{ route('shiftDates.view', ['shiftDate' => $shift->id]) }}">{{ $siteName }}</a>
                                                @else
                                                    {{ $siteName }}
                                                @endif
                                            </td>
                            ...
                            <tbody>
                                @forelse ($bookings as $booking)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if ($bookShiftDateId)
                                                <a href="{{ route('shiftDates.view', ['shiftDate' => $bookShiftDateId]) }}">{{ $bookLabel }}</a>
                                            @else
                                                {{ $bookLabel }}
                                            @endif
                                        </td>
        ...
        (function () {
            ...
            function render() {
                ...
                const makeItem = (label, page, opts = {}) => {
                    ...
                    const a = document.createElement(opts.disabled || opts.active ? 'span' : 'a');
