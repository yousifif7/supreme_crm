...
<div class="container">
    ...
    <div class="header">
        <div class="company">
            <h2>Supreme Protection</h2>
            <p>150 Chingford Road, Walthamstow, London, E17 4PL</p>
            <p>Email: admin@splconnect.co.uk</p>
        </div>
    ...
    <div class="footer">
        This payroll slip is generated by SPL Connect &bull; Supreme Protection Ltd
    </div>
