                                            ...
                                            <div class="document-card">
                                                <div class="document-image-wrapper">
                                                    <img src="{{ asset($staff?->fileUrl('proof_of_address_file', true)) }}"
                                                        alt="Proof of Address 1" class="document-image" loading="lazy" decoding="async" />
                                                    <div class="document-overlay">
                                            ...
                                            <div class="document-card">
                                                <div class="document-image-wrapper">
                                                    <img src="{{ asset($staff?->fileUrl('proof_of_address_file_2', true)) }}"
                                                        alt="Proof of Address 2" class="document-image" loading="lazy" decoding="async" />
                                                    <div class="document-overlay">
                                                        <a href="{{ $staff?->fileUrl('proof_of_address_file_2') }}"
                                                            target="_blank" class="view-btn">
                                                            <i class="ti ti-eye"></i>
                                                        </a>
                                                    </div>
