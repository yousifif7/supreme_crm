                    ...
                    <div class="tab-pane fade show active" id="basic-info" role="tabpanel"
                        ...
                        <div class="modal-body pb-0 ">
                            <div class="row">
                                <div class="col-md-12 mb-3">
                                    <div class="alert alert-info">
                                        ...
                                        <ul class="mb-0 small">
                                            ...
                                            <li><strong>Optional:</strong> Company Address, Contact Person, Contact Number, Email, Username, Password, Invoice Terms, Payment Terms, Department, VAT Registered, VAT Number, Pay Rate, PMVA Trained Officer, Is Active</li>
                                ...
                                <div class="col-md-4">
                                    <a href="{{ route('subcontractors.export.excel', ['template' => 1]) }}" class="btn btn-outline-primary w-100">
